...
from . import CONF_DREO_TUYA_MCU_ID, DreoTuyaMcuComponent, DreoTuyaSwitch
...
CONFIG_SCHEMA = (
    switch.switch_schema(DreoTuyaSwitch)
    .extend(
        {
...
async def to_code(config):
    ...
    cg.add(parent.register_switch(config[CONF_DATAPOINT], var))
